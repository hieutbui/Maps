...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		ellipse(55, 110, 12, 12);
		rect(50, 120, 12, 12);
		fill(color(255, 153, 18));
		ellipse(50, 170, 12, 12);
		fill(color(93, 138, 168));
		...
		text("Land Quake", 65, 110);
		text("Ocean Quake", 65, 125);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers){
			...
			for (Marker mk : quakeMarkers){
				EarthquakeMarker emarker = (EarthquakeMarker)mk;
				if (emarker.isOnLand){
					if (name.equals(emarker.getStringProperty("country"))){
						counter +=1;
					}
				}
			}
