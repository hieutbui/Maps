...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		float rightcornerX = x - TRI_SIZE;
		float rightcornerY = y + TRI_SIZE;
		float leftcornerX = x + TRI_SIZE;
		float leftcornerY = y + TRI_SIZE;
		float centercornerX = x;
		float centercornerY = y - TRI_SIZE;
		pg.fill(204, 0, 0);
		pg.triangle(rightcornerX, rightcornerY, leftcornerX, leftcornerY, centercornerX, centercornerY);
